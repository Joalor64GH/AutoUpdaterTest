 ...
 */
class AutoUpdater {
	private static inline var DOWNLOAD_URL = "https://github.com/Joalor64GH/AutoUpdaterTest/releases/latest/download/release-windows.zip";
	...
	private static function extractUpdate(zipPath:String):Void {
		try {
			...
			for (entry in entries) {
				...
				if (fileName == "Test.exe" || fileName == "lime.ndll") {
